...
class GameGUI:
    def __init__(self, root):
        ...
        self.tree = None
        self.step_count = 1  # Sākuma stāvoklis
    ...
    def ai_move(self):
        ...
        print(f"Datora gājiena laiks: {elapsed:.4f} sekundes")
    ...
    def end_game(self):
        ...
        end_text = f"Spēle beigusies! {result} Iegūtais skaitlis: {self.current_node.value}\nApstaigātie mezgli: {self.step_count}"
        self.output_label.config(text=end_text)
